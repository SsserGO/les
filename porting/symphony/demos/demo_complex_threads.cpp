...
main()
{
  ...
  QBMILPP problem1(c, 9, &A[0][0], 6, s, b);
  QBMILPP problem2(c, 9, &A[0][0], 6, s, b);
  QBMILPP problem3(c, 9, &A[0][0], 6, s, b);
  vector<QBMILPP> problems = vector<QBMILPP>();
  problems.push_back(problem1);
  problems.push_back(problem2);
  problems.push_back(problem3);
  for(vector<QBMILPP>::iterator it=problems.begin(); it!=problems.end(); it++){
  QBMILPP& problem=*it;
